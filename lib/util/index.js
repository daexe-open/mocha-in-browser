...
/* istanbul ignore next */
function print() {
	console.log.apply(console, (0, _from2.default)(arguments));
}

/* istanbul ignore next */
function printAndNewLine() {
	print.apply(null, (0, _from2.default)(arguments));
...
/* istanbul ignore next */
function finish(shouldBrowserClosed, proc, server, callback, err) {
...
module.exports = {
	...
	print: print,
	printAndNewLine: printAndNewLine,
	normalizeDir: normalizeDir,
	walkSync: walkSync,
	normalizeSlashes: normalizeSlashes,
	finish: finish,
	normalizeCliOptionValue: normalizeCliOptionValue,
	noop: noop,
