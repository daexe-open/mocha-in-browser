...
/* istanbul ignore next */
function generateCoverage(userConfig, coverage, cb) {
...
module.exports.helpers = {
  getLineCountBeforeCallbackFn: getLineCountBeforeCallbackFn,
  adjustLineNumbers: adjustLineNumbers,
  updatePathsToAbsPaths: updatePathsToAbsPaths
};